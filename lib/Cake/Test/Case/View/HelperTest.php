 ...
 */
	public function testAssetTimestamp() {
		...
		$result = $this->Helper->assetTimestamp(Configure::read('App.cssBaseUrl') . 'cake.generic.css_noo');
		$this->assertEquals(Configure::read('App.cssBaseUrl') . 'cake.generic.css_noo', $result);

		Configure::write('Asset.timestamp', true);
		Configure::write('debug', 0);

		$result = $this->Helper->assetTimestamp('/%3Cb%3E/cake.generic.css_noo');
		$this->assertEquals('/%3Cb%3E/cake.generic.css_noo', $result);
		...
		$result = $this->Helper->assetTimestamp(Configure::read('App.cssBaseUrl') . 'cake.generic.css_noo');
		$this->assertRegExp('/' . preg_quote(Configure::read('App.cssBaseUrl') . 'cake.generic.css_noo?', '/') . '[0-9]+/', $result);
		...
		$result = $this->Helper->assetTimestamp(Configure::read('App.cssBaseUrl') . 'cake.generic.css_noo?someparam');
		$this->assertEquals(Configure::read('App.cssBaseUrl') . 'cake.generic.css_noo?someparam', $result);

		$this->Helper->request->webroot = '/some/dir/';
		$result = $this->Helper->assetTimestamp('/some/dir/' . Configure::read('App.cssBaseUrl') . 'cake.generic.css_noo');
		$this->assertRegExp('/' . preg_quote(Configure::read('App.cssBaseUrl') . 'cake.generic.css_noo?', '/') . '[0-9]+/', $result);
	}
 ...
 */
	public function testAssetUrlTimestampForce() {
		...
		$result = $this->Helper->assetUrl('cake.generic.css_noo', array('pathPrefix' => Configure::read('App.cssBaseUrl')));
		$this->assertRegExp('/' . preg_quote(Configure::read('App.cssBaseUrl') . 'cake.generic.css_noo?', '/') . '[0-9]+/', $result);
	}
