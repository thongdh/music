 ...
 */
	public function testCssLink() {
		...
		$expected['link']['href'] = '/my/custom/path/cake.generic.css_noo';
		$this->assertTags($result, $expected);

		$result = $this->Html->css('cake.generic', array('pathPrefix' => 'http://cakephp.org/assets/css/'));
		$expected['link']['href'] = 'http://cakephp.org/assets/css/cake.generic.css_noo';
		$this->assertTags($result, $expected);

		$previousConfig = Configure::read('App.cssBaseUrl');
		Configure::write('App.cssBaseUrl', '//cdn.cakephp.org/css/');
		$result = $this->Html->css('cake.generic');
		$expected['link']['href'] = '//cdn.cakephp.org/css/cake.generic.css_noo';
		$this->assertTags($result, $expected);
		...
		$result = $this->Html->css('//example.com/css/cake.generic.css_noo');
